...
const LESSON_INDEX: Record<string, string> = {
  ...
  'en/mathematics/quaternions-and-numerical-optimization': 'en/mathematics/quaternions-and-numerical-optimization.mdx',
  ...
  'en/kinematics/six-dof-arm-kinematics-and-spherical-wrist': 'en/kinematics/six-dof-arm-kinematics-and-spherical-wrist.mdx',
  ...
  'en/perception/visual-odometry-and-rgbd-depth-processing': 'en/perception/visual-odometry-and-rgbd-depth-processing.mdx',
  ...
  'en/manipulation/trajectory-generation-and-grasp-planning': 'en/manipulation/trajectory-generation-and-grasp-planning.mdx',
  ...
  'en/advanced/reinforcement-learning-for-robotics': 'en/advanced/reinforcement-learning-for-robotics.mdx',
  'en/advanced/ros2-architecture-and-navigation-stack': 'en/advanced/ros2-architecture-and-navigation-stack.mdx',
  'en/advanced/foundation-models-and-embodied-ai': 'en/advanced/foundation-models-and-embodied-ai.mdx',
  'en/control/model-predictive-control-mpc': 'en/control/model-predictive-control-mpc.mdx',
  'en/dynamics/rigid-body-and-lagrangian-dynamics': 'en/dynamics/rigid-body-and-lagrangian-dynamics.mdx',
  'en/legged/zero-moment-point-and-lipm': 'en/legged/zero-moment-point-and-lipm.mdx',
  'en/aerial/quadrotor-attitude-cascaded-control': 'en/aerial/quadrotor-attitude-cascaded-control.mdx',
  'en/marine/fossen-marine-craft-dynamics': 'en/marine/fossen-marine-craft-dynamics.mdx',
  ...
  'id/mathematics/quaternions-and-numerical-optimization': 'id/mathematics/quaternions-and-numerical-optimization.mdx',
  ...
  'id/kinematics/six-dof-arm-kinematics-and-spherical-wrist': 'id/kinematics/six-dof-arm-kinematics-and-spherical-wrist.mdx',
  ...
  'id/perception/visual-odometry-and-rgbd-depth-processing': 'id/perception/visual-odometry-and-rgbd-depth-processing.mdx',
  ...
  'id/manipulation/trajectory-generation-and-grasp-planning': 'id/manipulation/trajectory-generation-and-grasp-planning.mdx',
  ...
  'id/advanced/reinforcement-learning-for-robotics': 'id/advanced/reinforcement-learning-for-robotics.mdx',
  'id/advanced/ros2-architecture-and-navigation-stack': 'id/advanced/ros2-architecture-and-navigation-stack.mdx',
  'id/advanced/foundation-models-and-embodied-ai': 'id/advanced/foundation-models-and-embodied-ai.mdx',
  'id/control/model-predictive-control-mpc': 'id/control/model-predictive-control-mpc.mdx',
  'id/dynamics/rigid-body-and-lagrangian-dynamics': 'id/dynamics/rigid-body-and-lagrangian-dynamics.mdx',
  'id/legged/zero-moment-point-and-lipm': 'id/legged/zero-moment-point-and-lipm.mdx',
  'id/aerial/quadrotor-attitude-cascaded-control': 'id/aerial/quadrotor-attitude-cascaded-control.mdx',
  'id/marine/fossen-marine-craft-dynamics': 'id/marine/fossen-marine-craft-dynamics.mdx',
};
