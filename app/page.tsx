...
export default function HomePage() {
  ...
  const interactiveSimulators = [
    ...
    {
      titleEn: 'A* vs Dijkstra Grid Planning',
      titleId: 'Perencanaan Grid A* vs Dijkstra',
    ...
    },
    {
      ...
      titleId: 'Pemetaan Okupansi Grid Log-Odds',
    ...
    {
      titleEn: 'Factor Graph SLAM & Optimizer',
      titleId: 'Graf Faktor & Optimasi SLAM',
      descEn: 'Non-linear least squares sparse normal equations solver',
      descId: 'Solver persamaan normal tersebar kuadrat terkecil non-linear',
      href: '/learn/advanced/factor-graph-optimization',
      icon: '🔀',
      tag: 'Level 10',
    },
    {
      titleEn: '3D Gaussian Splatting SLAM',
      titleId: '3D Gaussian Splatting SLAM',
      descEn: 'Differentiable 3D anisotropic Gaussian radiance rasterization',
      descId: 'Rasterisasi pancaran 3D Gaussian anisotropik diferensiabel',
      href: '/learn/advanced/3d-gaussian-splatting-slam',
      icon: '✨',
      tag: 'Level 10',
    },
    {
      titleEn: '6-DOF UAV Flight Dynamics',
      titleId: 'Dinamika Terbang 6-DOF UAV',
      descEn: 'Multirotor collective thrust & reaction torque allocation',
      descId: 'Dorongan kolektif multirotor & alokasi torsi reaksi',
      href: '/learn/fundamentals/aerial-drone-principles',
      icon: '🚁',
      tag: 'Level 0',
    },
    {
      titleEn: 'Zero Moment Point (ZMP) Locomotion',
      titleId: 'Lokomosi Zero Moment Point (ZMP)',
      descEn: 'Legged bipedal dynamic balance in support polygon',
      descId: 'Keseimbangan dinamis robot berkaki di poligon tumpuan',
      href: '/learn/fundamentals/legged-robotics-fundamentals',
      icon: '🦿',
      tag: 'Level 0',
    },
    {
      titleEn: 'VLA Diffusion Policy Trajectory',
      titleId: 'Trajektori Diffusion Policy VLA',
      descEn: 'Continuous action denoising for robot manipulation',
      descId: 'Denoising aksi kontinu untuk manipulasi lengan robot',
      href: '/learn/advanced/vla-and-diffusion-policies',
      icon: '🦾',
      tag: 'Level 10',
    },
    {
      titleEn: 'Multi-Agent Formation Control',
      titleId: 'Kendali Formasi Multi-Agen',
      descEn: 'Decentralized flocking & Laplacian consensus',
      descId: 'Flocking terdesentralisasi & konsensus graf Laplacian',
