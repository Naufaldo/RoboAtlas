...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col items-center w-full">
      {/* 1. Hero Section */}
      <section className="relative w-full overflow-hidden pt-10 pb-16 md:pt-16 md:pb-24 border-b border-slate-800/80">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-6 space-y-6 text-center lg:text-left">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-cyan-500/10 border border-cyan-500/30 text-cyan-300 text-xs font-mono shadow-sm">
                ...
                <span>Next-Gen Robotics Textbook + Interactive Simulator</span>
              </div>
              ...
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 pt-1">
                ...
                <Link
                  href="/algorithms"
                  className="flex items-center gap-2 px-6 py-3.5 rounded-xl bg-slate-900/90 hover:bg-slate-800 text-slate-200 border border-slate-700 font-mono text-sm transition-all hover:border-cyan-500/40"
                >
              ...
              {/* Feature Highlights */}
              <div className="pt-3 flex flex-wrap items-center justify-center lg:justify-start gap-5 text-xs font-mono text-slate-400">
                <span className="flex items-center gap-1.5">
                  <CheckCircle2 className="w-4 h-4 text-emerald-400" /> 100% Client-Side
                </span>
                <span className="flex items-center gap-1.5">
                  <CheckCircle2 className="w-4 h-4 text-emerald-400" /> Zero Backend
                </span>
                <span className="flex items-center gap-1.5">
      ...
      <section className="w-full py-16 border-b border-slate-800/80 bg-slate-950/40">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-10">
            <span className="text-xs font-mono uppercase tracking-widest text-cyan-400 font-semibold">
              The Educational Methodology
            </span>
            <h2 className="text-2xl sm:text-3xl font-extrabold tracking-tight text-slate-100 mt-1.5">
              From Mathematical Theory to Running Code
            </h2>
            <p className="text-xs sm:text-sm text-slate-400 mt-2">
              Every topic adheres to a disciplined 6-stage engineering learning cycle.
            </p>
          </div>
              ...
              >
                <div>
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-mono font-bold text-cyan-400 px-1.5 py-0.5 rounded bg-cyan-500/10 border border-cyan-500/20">
                      {pillar.step}
                    </span>
                  </div>
                  <h3 className="text-sm font-bold text-slate-100 mt-3">{pillar.title}</h3>
                </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold tracking-tight text-slate-100 mt-1">
                7 Core Robotics Domains
              </h2>
              <p className="text-sm text-slate-400 mt-1">
                Comprehensive curriculum coverage from kinematics to multi-agent swarm consensus.
              </p>
            </div>
                ...
                >
                  <div>
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-gradient-to-br from-cyan-500/15 to-blue-600/15 border border-cyan-500/30 text-cyan-400 group-hover:scale-105 transition-transform shadow-sm">
                  ...
                  <div className="mt-6 pt-4 border-t border-slate-800/80 flex items-center justify-between text-xs font-mono text-slate-400 group-hover:text-cyan-400 transition-colors">
                    <span className="font-medium">Explore domain</span>
      ...
      <section className="w-full py-16 bg-slate-950/50 border-b border-slate-800/80">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              ...
              >
                ...
                <div className="mt-4 pt-3 border-t border-slate-800/60 flex items-center justify-between">
                  ...
                  <Link
                    ...
                    className="text-xs font-mono text-cyan-400 hover:text-cyan-300 font-medium flex items-center gap-1"
                  >
                    <span>Details</span>
                    <span>→</span>
                  </Link>
      ...
      <section className="w-full py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-2xl glass-panel border border-slate-800 p-8 shadow-xl">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              <div className="lg:col-span-8 space-y-3">
                ...
                <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
                  RoboAtlas is developed as an original, interactive TypeScript educational web platform inspired by the curriculum breadth of Atsushi Sakai’s renowned <em>PythonRobotics</em> repository and classical robotics papers. All educational explanations and browser simulations are engineered from first principles.
                </p>
              </div>
              ...
              <div className="lg:col-span-4 flex flex-col sm:flex-row lg:flex-col gap-3 justify-center">
                <a
                  ...
                  className="px-4 py-3 rounded-xl bg-slate-900 hover:bg-slate-800 text-slate-200 text-xs font-mono text-center border border-slate-700 hover:border-cyan-500/40 transition-all font-medium"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-4 py-3 rounded-xl bg-cyan-500/10 hover:bg-cyan-500/20 text-cyan-300 text-xs font-mono text-center border border-cyan-500/30 transition-all font-medium"
                >
