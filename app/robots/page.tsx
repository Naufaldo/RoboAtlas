...
const ROBOT_PLATFORMS: RobotPlatform[] = [
  {
    ...
    fundamentalsUsed: [
      { name: '3D Spatial Geometry & SO(3)', href: '/learn/fundamentals' },
      { name: 'Matrix Foundations SE(3)', href: '/learn/fundamentals' },
      { name: 'Geometric Jacobians', href: '/learn/fundamentals' },
      { name: 'Euler-Lagrange Dynamics', href: '/learn/fundamentals' },
    ],
  ...
  },
  {
    ...
    fundamentalsUsed: [
      { name: '2D Geometry & Planar Transforms', href: '/learn/fundamentals' },
      { name: 'Unicycle Velocity Kinematics', href: '/learn/fundamentals' },
      { name: 'A* Path Planning', href: '/learn/planning' },
      { name: 'Pure Pursuit & Stanley Control', href: '/learn/control' },
      { name: 'Monte Carlo Localization (MCL)', href: '/learn/localization' },
      { name: 'Log-Odds Occupancy Mapping', href: '/learn/mapping' },
    ],
  ...
  },
  {
    ...
    fundamentalsUsed: [
      { name: '3D Spatial Geometry & Euler ZYX', href: '/learn/fundamentals' },
      { name: 'Newton-Euler Dynamics', href: '/learn/fundamentals' },
      { name: 'PID Feedback Control', href: '/learn/control' },
      { name: 'Quintic Polynomial Splines', href: '/learn/fundamentals' },
    ],
  ...
  },
  {
    ...
    fundamentalsUsed: [
      { name: '3D Spatial Transforms & Quaternions', href: '/learn/fundamentals' },
      { name: 'Newton-Euler Marine Equations', href: '/learn/fundamentals' },
      { name: 'State-Space Estimators', href: '/learn/fundamentals' },
    ],
  ...
  },
  {
    ...
    fundamentalsUsed: [
      { name: 'Euler-Lagrange Multibody Dynamics', href: '/learn/fundamentals' },
      { name: 'Geometric Jacobians', href: '/learn/fundamentals' },
      { name: 'Trajectory Tracking', href: '/learn/control' },
    ],
